...
public class ModItems {
    ...
    public static final Item ARTS_TUBE = registerItems("arts_tube",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item ARTS_VIAL = registerItems("arts_vial",new Item(new Item.Settings().rarity(Rarity.RARE)));
    public static final Item ASHPIN_REMEDY = registerItems("ashpin_remedy",new Item(new Item.Settings().rarity(Rarity.RARE)));
    public static final Item BIZARROTACK = registerItems("bizarrotack",new Item(new Item.Settings().rarity(Rarity.UNCOMMON)));
    public static final Item BIZARRO_CHILI = registerItems("bizarro_chili",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item BLANCHED_REMEDY = registerItems("blanched_remedy",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    ...
    public static final Item BUCKPILL_L = registerItems("buckpill_l",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item BUCKPILL_RF = registerItems("buckpill_rf",new ModEpicItem(new Item.Settings()));
    public static final Item BUCKPILL_S = registerItems("buckpill_s",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item BUCK_CAPSULE_A = registerItems("buck_capsule_a",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item BUCK_CAPSULE_B = registerItems("buck_capsule_b",new Item(new Item.Settings().rarity(Rarity.RARE)));
    public static final Item BUCK_CAPSULE_C = registerItems("buck_capsule_c",new Item(new Item.Settings().rarity(Rarity.RARE)));
    public static final Item BUGTACK = registerItems("bugtack",new Item(new Item.Settings().rarity(Rarity.RARE)));
    public static final Item CANNED_CITROME_A = registerItems("canned_citrome_a",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item CANNED_CITROME_B = registerItems("canned_citrome_b",new Item(new Item.Settings().rarity(Rarity.RARE)));
    public static final Item CANNED_CITROME_C = registerItems("canned_citrome_c",new Item(new Item.Settings().rarity(Rarity.RARE)));
    ...
    public static final Item CARTILAGE_TACK = registerItems("cartilage_tack",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item CHITIN_BIT = registerItems("chitin_bit",new Item(new Item.Settings().rarity(Rarity.UNCOMMON)));
    public static final Item CITROBUCKY_MIX = registerItems("citrobucky_mix",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item CITROME = registerItems("citrome",new BlockItem(ModBlocks.CITROME_BLOCK, new Item.Settings()));
    public static final Item CITROME_JAM = registerItems("citrome_jam",new Item(new Item.Settings().rarity(Rarity.UNCOMMON)));
    ...
    public static final Item CITROME_PUDDING = registerItems("citrome_pudding",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    ...
    public static final Item CITROMIX_L = registerItems("citromix_l",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item CITROMIX_RF = registerItems("citromix_rf",new ModEpicItem(new Item.Settings()));
    public static final Item CITROMIX_S = registerItems("citromix_ss",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item COARSE_FLATBREAD = registerItems("coarse_flatbread",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item CORRECTIVE_REMEDY = registerItems("corrective_remedy",new ModEpicItem(new Item.Settings()));
    ...
    public static final Item FILLET_CONFIT = registerItems("fillet_confit",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    ...
    public static final Item FIRESTOVE_RICE = registerItems("firestove_rice",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item FIRETACK = registerItems("firetack",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    ...
    public static final Item FORTIFYING_INFUSION = registerItems("fortifying_infusion",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item GARDEN_FRIED_RICE = registerItems("garden_fried_rice",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item GARDEN_STIR_FRY = registerItems("garden_stir_fry",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item GINSENG_MEAT_STEW = registerItems("ginseng_meat_stew",new ModEpicItem(new Item.Settings()));
    ...
    public static final Item HOT_CRUNCHY_RIBS = registerItems("hot_crunchy_ribs",new ModEpicItem(new Item.Settings()));
    public static final Item INDUSTRIAL_EXPLOSIVE = registerItems("industrial_explosive",new Item(new Item.Settings().rarity(Rarity.RARE)));
    ...
    public static final Item JINCAO_INFUSION = registerItems("jincao_infusion",new ModEpicItem(new Item.Settings()));
    ...
    public static final Item JINCAO_TISANE = registerItems("jincao_tisane",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item KUNST_TUBE = registerItems("kunst_tube",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item KUNST_VIAL = registerItems("kunst_vial",new Item(new Item.Settings().rarity(Rarity.RARE)));
    public static final Item LC_BATTERY = registerItems("lc_battery",new Item(new Item.Settings().rarity(Rarity.RARE)));
    public static final Item MEAT_STIR_FRY = registerItems("meat_stir_fry",new ModEpicItem(new Item.Settings()));
    public static final Item MOSSFIELD_PIE = registerItems("mossfield_pie",new ModEpicItem(new Item.Settings()));
    ...
    public static final Item PERPLEXING_MEDICATION = registerItems("perplexing_medication",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item PRESERVE_STEW = registerItems("preserve_stew",new Item(new Item.Settings().rarity(Rarity.RARE)));
    ...
    public static final Item SAVORY_FILLET = registerItems("savory_fillet",new Item(new Item.Settings().rarity(Rarity.UNCOMMON)));
    public static final Item SAVORY_TANGBAO = registerItems("savory_tangbao",new ModEpicItem(new Item.Settings()));
    public static final Item SAVORY_TANGMIAN = registerItems("savory_tangmian",new Item(new Item.Settings().rarity(Rarity.UNCOMMON)));
    ...
    public static final Item SENSORY_REMEDY = registerItems("sensory_remedy",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item SMOKED_RICEBALL = registerItems("smoked_riceball",new ModEpicItem(new Item.Settings()));
    ...
    public static final Item TARTPEPPER_PICKLE = registerItems("tartpepper_pickle",new Item(new Item.Settings().rarity(Rarity.RARE)));
    public static final Item TARTPEPPER_SALAD = registerItems("tartpepper_salad",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    ...
    public static final Item VALLEY_GRAYBREAD = registerItems("valley_graybread",new Item(new Item.Settings().rarity(Rarity.EPIC)));
    public static final Item WOOD = registerItems("wood",new Item(new Item.Settings()));
    public static final Item WULING_FRIED_RICE = registerItems("wuling_fried_rice",new ModEpicItem(new Item.Settings()));
    ...
    public static final Item YAZHEN_SPRAY_L = registerItems("yazhen_spray_l",new ModEpicItem(new Item.Settings()));
    public static final Item YAZHEN_SPRAY_S = registerItems("yazhen_spray_s",new Item(new Item.Settings().rarity(Rarity.EPIC)));
