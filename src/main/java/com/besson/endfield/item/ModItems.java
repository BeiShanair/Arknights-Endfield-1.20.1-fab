...
public class ModItems {
    ...
    public static final Item AMETHYST_FIBER = registerItems("amethyst_fiber",new Item(new Item.Settings()));
    public static final Item AMETHYST_ORE = registerItems("amethyst_ore",new Item(new Item.Settings()));
    public static final Item AMETHYST_PART = registerItems("amethyst_part",new Item(new Item.Settings()));
    public static final Item AMETHYST_POWDER = registerItems("amethyst_powder",new Item(new Item.Settings()));
    public static final Item ARTS_TUBE = registerItems("arts_tube",new Item(new Item.Settings()));
    public static final Item ARTS_VIAL = registerItems("arts_vial",new Item(new Item.Settings()));
    public static final Item ASHPIN_REMEDY = registerItems("ashpin_remedy",new Item(new Item.Settings()));
    ...
    public static final Item BUCKPILL_RF = registerItems("buckpill_rf",new Item(new Item.Settings()));
    public static final Item BUCKPILL_S = registerItems("buckpill_s",new Item(new Item.Settings()));
    public static final Item BUCK_CAPSULE_A = registerItems("buck_capsule_a",new Item(new Item.Settings()));
    public static final Item BUCK_CAPSULE_B = registerItems("buck_capsule_b",new Item(new Item.Settings()));
    public static final Item BUCK_CAPSULE_C = registerItems("buck_capsule_c",new Item(new Item.Settings()));
    public static final Item BUGTACK = registerItems("bugtack",new Item(new Item.Settings()));
    public static final Item CANNED_CITROME_A = registerItems("canned_citrome_a",new Item(new Item.Settings()));
    public static final Item CANNED_CITROME_B = registerItems("canned_citrome_b",new Item(new Item.Settings()));
    public static final Item CANNED_CITROME_C = registerItems("canned_citrome_c",new Item(new Item.Settings()));
    public static final Item CARBON = registerItems("carbon",new Item(new Item.Settings()));
    public static final Item CARBON_POWDER = registerItems("carbon_powder",new Item(new Item.Settings()));
    public static final Item CARTILAGE_BIT = registerItems("cartilage_bit",new Item(new Item.Settings()));
    ...
    public static final Item CITROME_PUDDING = registerItems("citrome_pudding",new Item(new Item.Settings()));
    ...
    public static final Item CRYSTON_COMPONENT = registerItems("cryston_component",new Item(new Item.Settings()));
    public static final Item CRYSTON_FIBER = registerItems("cryston_fiber",new Item(new Item.Settings()));
    public static final Item CRYSTON_PART = registerItems("cryston_part",new Item(new Item.Settings()));
    public static final Item CRYSTON_POWDER = registerItems("cryston_powder",new Item(new Item.Settings()));
    public static final Item CUPRIUM = registerItems("cuprium",new Item(new Item.Settings()));
    public static final Item CUPRIUM_COMPONENT = registerItems("cuprium_component",new Item(new Item.Settings()));
    public static final Item CUPRIUM_JAR = registerItems("cuprium_jar",new Item(new Item.Settings()));
    public static final Item CUPRIUM_ORE = registerItems("cuprium_ore",new Item(new Item.Settings()));
    public static final Item CUPRIUM_PART = registerItems("cuprium_part",new Item(new Item.Settings()));
    public static final Item CUPRIUM_POWDER = registerItems("cuprium_powder",new Item(new Item.Settings()));
    public static final Item DENSE_CARBON_POWDER = registerItems("dense_carbon_powder",new Item(new Item.Settings()));
    public static final Item DENSE_FERRIUM_POWDER = registerItems("dense_ferrium_powder",new Item(new Item.Settings()));
    public static final Item DENSE_ORIGINIUM_POWDER = registerItems("dense_originium_powder",new Item(new Item.Settings()));
    public static final Item DENSE_ORIGOCRUST_POWDER = registerItems("dense_origocrust_powder",new Item(new Item.Settings()));
    public static final Item FERRIUM = registerItems("ferrium",new Item(new Item.Settings()));
    public static final Item FERRIUM_BOTTLE = registerItems("ferrium_bottle",new Item(new Item.Settings()));
    public static final Item FERRIUM_COMPONENT = registerItems("ferrium_component",new Item(new Item.Settings()));
    public static final Item FERRIUM_ORE = registerItems("ferrium_ore",new Item(new Item.Settings()));
    public static final Item FERRIUM_PART = registerItems("ferrium_part",new Item(new Item.Settings()));
    ...
    public static final Item GARDEN_STIR_FRY = registerItems("garden_stir_fry",new Item(new Item.Settings()));
    public static final Item GINSENG_MEAT_STEW = registerItems("ginseng_meat_stew",new Item(new Item.Settings()));
    public static final Item GLOWBUG = registerItems("glowbug",new Item(new Item.Settings()));
    public static final Item GRASS_CHAFF = registerItems("grass_chaff",new Item(new Item.Settings()));
    public static final Item GROUND_BUCKFLOWER_POWDER = registerItems("ground_buckflower_powder",new Item(new Item.Settings()));
    public static final Item GROUND_CITROME_POWDER = registerItems("ground_citrome_powder",new Item(new Item.Settings()));
    public static final Item HC_BATTERY = registerItems("hc_battery",new Item(new Item.Settings()));
    public static final Item HOLLOW_BONE = registerItems("hollow_bone",new Item(new Item.Settings()));
    ...
    public static final Item JINCAO_TEA = registerItems("jincao_tea",new Item(new Item.Settings()));
    public static final Item JINCAO_TISANE = registerItems("jincao_tisane",new Item(new Item.Settings()));
    public static final Item KUNST_TUBE = registerItems("kunst_tube",new Item(new Item.Settings()));
    public static final Item KUNST_VIAL = registerItems("kunst_vial",new Item(new Item.Settings()));
    public static final Item LC_BATTERY = registerItems("lc_battery",new Item(new Item.Settings()));
    public static final Item MEAT_STIR_FRY = registerItems("meat_stir_fry",new Item(new Item.Settings()));
    public static final Item MOSSFIELD_PIE = registerItems("mossfield_pie",new Item(new Item.Settings()));
    ...
    public static final Item SAVORY_TANGBAO = registerItems("savory_tangbao",new Item(new Item.Settings()));
    public static final Item SAVORY_TANGMIAN = registerItems("savory_tangmian",new Item(new Item.Settings()));
    public static final Item SCORCHBUG = registerItems("scorchbug",new Item(new Item.Settings()));
    public static final Item SC_BATTERY = registerItems("sc_battery",new Item(new Item.Settings()));
    public static final Item SENSORY_REMEDY = registerItems("sensory_remedy",new Item(new Item.Settings()));
    public static final Item SMOKED_RICEBALL = registerItems("smoked_riceball",new Item(new Item.Settings()));
    public static final Item SOAKED_WOOD = registerItems("soaked_wood",new Item(new Item.Settings()));
    public static final Item SOAKED_WOODCHIP = registerItems("soaked_woodchip",new Item(new Item.Settings()));
    public static final Item STABILIZED_CARBON = registerItems("stabilized_carbon",new Item(new Item.Settings()));
    public static final Item STEEL = registerItems("steel",new Item(new Item.Settings()));
