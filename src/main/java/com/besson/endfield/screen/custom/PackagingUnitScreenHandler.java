...
public class PackagingUnitScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public final PackagingUnitBlockEntity entity;
    ...
    public PackagingUnitScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate propertyDelegate) {
        super(ModScreens.PACKAGING_UNIT_SCREEN, syncId);
        checkSize((Inventory) blockEntity, 3);
        this.inventory = (Inventory) blockEntity;
        inventory.onOpen(playerInventory.player);
        this.propertyDelegate = propertyDelegate;
        this.entity = (PackagingUnitBlockEntity) blockEntity;
