...
public abstract class BaseIOScreenHandler<B extends BaseIOBlockEntity<?>> extends ScreenHandler {
    protected final SimpleInventory inputInv;
    protected final SimpleInventory outputInv;
    protected final PropertyDelegate propertyDelegate;
    
    public final B entity;
    public BaseIOScreenHandler(@Nullable ScreenHandlerType<?> type, int syncId, PlayerInventory playerInventory, B blockEntity, PropertyDelegate propertyDelegate, int size) {
        super(type, syncId);
