...
public class DepotUnloaderScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public final DepotUnloaderBlockEntity entity;

    public DepotUnloaderScreenHandler(int syncId, PlayerInventory playerInventory, PacketByteBuf buf) {
        this(syncId, playerInventory, Objects.requireNonNull(getClientEntity(playerInventory, buf)),
                new ArrayPropertyDelegate(1));
    }

    public DepotUnloaderScreenHandler(int syncId, PlayerInventory playerInventory, DepotUnloaderBlockEntity blockEntity, PropertyDelegate propertyDelegate) {
        super(ModScreens.DEPOT_UNLOADER_SCREEN, syncId);
        ...
        this.addSlot(new Slot(inventory, 0, 104, 37) {
            ...
            public void markDirty() {
                super.markDirty();
                DepotUnloaderScreenHandler.this.onContentChanged(this.inventory);
    ...
    private static DepotUnloaderBlockEntity getClientEntity(PlayerInventory playerInventory, PacketByteBuf buf) {
