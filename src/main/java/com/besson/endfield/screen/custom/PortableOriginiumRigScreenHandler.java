...
public class PortableOriginiumRigScreenHandler extends ScreenHandler {
    ...
    public PortableOriginiumRigScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate propertyDelegate) {
        super(ModScreens.PORTABLE_ORIGINIUM_RIG_SCREEN, syncId);
        checkSize((Inventory) blockEntity, 1);
        this.inventory = (Inventory) blockEntity;
        inventory.onOpen(playerInventory.player);
        this.propertyDelegate = propertyDelegate;
        this.entity = (PortableOriginiumRigBlockEntity) blockEntity;
