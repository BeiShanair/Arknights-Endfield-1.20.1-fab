...
public class RefiningUnitScreenHandler extends ScreenHandler {
    ...
    public RefiningUnitScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate propertyDelegate) {
        super(ModScreens.REFINING_UNIT_SCREEN, syncId);
        checkSize((Inventory) blockEntity, 2);
        this.inventory = (Inventory) blockEntity;
        inventory.onOpen(playerInventory.player);
        this.propertyDelegate = propertyDelegate;
        this.entity = (RefiningUnitBlockEntity) blockEntity;
