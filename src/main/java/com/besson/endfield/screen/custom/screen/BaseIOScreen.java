...
import com.besson.endfield.screen.custom.screenHandler.BaseIOScreenHandler;
...
public abstract class BaseIOScreen<T extends BaseIOScreenHandler<B>, B extends BaseIOBlockEntity<?>> extends HandledScreen<T> {
    protected final Identifier TEXTURE = setTexture();
    protected final B entity;
    public BaseIOScreen(T handler, PlayerInventory inventory, Text title) {
