...
import com.besson.endfield.screen.custom.screenHandler.MouldingUnitScreenHandler;
...
public class MouldingUnitScreen extends BaseIOScreen<MouldingUnitScreenHandler, MouldingUnitBlockEntity> {
    ...
    protected Identifier setTexture() {
        return new Identifier(ArknightsEndfield.MOD_ID, "textures/gui/moulding_unit.png");
    }
