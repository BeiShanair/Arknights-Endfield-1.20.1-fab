...
import com.besson.endfield.blockentity.custom.production1.SeedPickingUnitSideBlockEntity;
...
public class SeedPickingUnitBlock extends ModBlockEntityWithFacing {
    public SeedPickingUnitBlock(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (!world.isClient()) {
            NamedScreenHandlerFactory screenHandlerFactory = ((SeedPickingUnitBlockEntity) world.getBlockEntity(pos));
