...
public class SeedPickingUnitSideBlock extends ModBlockEntityWithFacing {
    public SeedPickingUnitSideBlock(Settings settings) {
        super(settings);
    }
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.SEED_PICKING_UNIT_SIDE, SeedPickingUnitSideBlockEntity::tick);
    }

    @Override
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModItems.SEED_PICKING_UNIT_ITEM);
    }
}
