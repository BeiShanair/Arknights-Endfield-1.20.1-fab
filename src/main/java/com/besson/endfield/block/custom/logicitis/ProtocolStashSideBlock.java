...
public class ProtocolStashSideBlock extends ModBlockEntityWithFacing {
    public ProtocolStashSideBlock(Settings settings) {
        super(settings);
    }
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.PROTOCOL_STASH_SIDE, ProtocolStashSideBlockEntity::tick);
    }

    @Override
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModItems.PROTOCOL_STASH_ITEM);
    }
}
