...
import com.besson.endfield.blockentity.custom.production2.GearingUnitSideBlockEntity;
...
public class GearingUnitSideBlock extends ModBlockEntityWithFacing {
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.GEARING_UNIT_SIDE, GearingUnitSideBlockEntity::tick);
    }

    @Override
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModItems.GEARING_UNIT_ITEM);
    }
}
