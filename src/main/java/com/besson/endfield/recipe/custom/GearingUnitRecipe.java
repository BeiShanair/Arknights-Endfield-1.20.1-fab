...
public class GearingUnitRecipe implements Recipe<SimpleInventory> {
    private final Identifier id;
    private final DefaultedList<InputEntry> input;
    private final ItemStack output;

    public GearingUnitRecipe(Identifier id, DefaultedList<InputEntry> input, ItemStack output) {
        this.id = id;
        this.input = input;
        this.output = output;
    }
    ...
    public static class Type implements RecipeType<GearingUnitRecipe> {
        public static final Type INSTANCE = new Type();
        public static final String ID = "gearing_unit";
    }
    ...
    public static class Serializer implements RecipeSerializer<GearingUnitRecipe> {
        ...
        @Override
        public GearingUnitRecipe read(Identifier id, JsonObject json) {
            ...
            return new GearingUnitRecipe(id, inputs, output);
        }

        @Override
        public GearingUnitRecipe read(Identifier id, PacketByteBuf buf) {
        ...
        @Override
        public void write(PacketByteBuf buf, GearingUnitRecipe recipe) {
