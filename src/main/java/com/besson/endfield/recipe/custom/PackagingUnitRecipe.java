...
public class PackagingUnitRecipe implements Recipe<SimpleInventory> {
    private final Identifier id;
    private final DefaultedList<InputEntry> input;
    private final ItemStack output;

    public PackagingUnitRecipe(Identifier id, DefaultedList<InputEntry> input, ItemStack output) {
        this.id = id;
        this.input = input;
        this.output = output;
    }
    ...
    public static class Type implements RecipeType<PackagingUnitRecipe> {
        public static final Type INSTANCE = new Type();
        public static final String ID = "packaging_unit";
    }

    public static class Serializer implements RecipeSerializer<PackagingUnitRecipe> {

        public static final Serializer INSTANCE = new Serializer();
        public static final String ID = "packaging_unit";

        @Override
        public PackagingUnitRecipe read(Identifier id, JsonObject json) {
            ...
            return new PackagingUnitRecipe(id, inputs, output);
        }

        @Override
        public PackagingUnitRecipe read(Identifier id, PacketByteBuf buf) {
        ...
        @Override
        public void write(PacketByteBuf buf, PackagingUnitRecipe recipe) {
