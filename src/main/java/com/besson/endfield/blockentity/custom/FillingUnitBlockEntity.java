...
public class FillingUnitBlockEntity extends BlockEntity implements SidedInventory, GeoBlockEntity, ExtendedScreenHandlerFactory, ImplementedInventory, ElectrifiableDevice {
    ...
    public int[] getAvailableSlots(Direction side) {
        ...
        if (state != null && state.contains(FillingUnitBlock.FACING)) {
            Direction facing = state.get(FillingUnitBlock.FACING);
            if (side == facing) {
                return INPUT_SLOTS;
