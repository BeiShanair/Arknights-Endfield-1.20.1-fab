...
public class ShreddingUnitSideBlockEntity extends BlockEntity implements SidedInventory, ImplementedInventory {
    ...
    public DefaultedList<ItemStack> getItems() {
        ShreddingUnitBlockEntity parent  = getParentBlock();
        if (parent != null) {
    ...
    public int[] getAvailableSlots(Direction side) {
        ShreddingUnitBlockEntity entity = getParentBlock();
