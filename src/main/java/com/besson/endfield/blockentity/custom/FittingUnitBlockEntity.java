...
public class FittingUnitBlockEntity extends BlockEntity implements SidedInventory, GeoBlockEntity, ExtendedScreenHandlerFactory, ImplementedInventory, ElectrifiableDevice {
    ...
    public FittingUnitBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.FITTING_UNIT, pos, state);
    ...
    public void readNbt(NbtCompound nbt) {
        ...
        this.progress = nbt.getInt("fitting.progress");
        this.storedPower = nbt.getInt("fitting.storedPower");
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        nbt.putInt("fitting.progress", this.progress);
        nbt.putInt("fitting.storedPower", this.storedPower);
        nbt.putBoolean("isWorking", this.isWorking);
    }

    public static void tick(World world, BlockPos pos, BlockState state, FittingUnitBlockEntity be) {
    ...
    private Optional<FittingUnitRecipe> getMatchRecipe(World world) {
    ...
    public int[] getAvailableSlots(Direction side) {
        ...
        if (state != null && state.contains(FittingUnitBlock.FACING)) {
            Direction facing = state.get(FittingUnitBlock.FACING);
            if (side == facing) {
                return INPUT_SLOTS;
