...
import com.besson.endfield.compat.category.GearingUnitCategory;
...
public class GearingUnitDisplay implements Display {
    private final List<EntryIngredient> inputs;
    private final List<EntryIngredient> outputs;

    public GearingUnitDisplay(GearingUnitRecipe recipe) {
    ...
    public CategoryIdentifier<?> getCategoryIdentifier() {
        return GearingUnitCategory.GEARING_UNIT;
    }
}
