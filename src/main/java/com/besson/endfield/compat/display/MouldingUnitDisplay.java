...
import com.besson.endfield.compat.category.MouldingUnitCategory;
...
public class MouldingUnitDisplay implements Display {
    private final List<EntryIngredient> inputs;
    private final List<EntryIngredient> outputs;

    public MouldingUnitDisplay(MouldingUnitRecipe recipe) {
    ...
    public CategoryIdentifier<?> getCategoryIdentifier() {
        return MouldingUnitCategory.MOULDING_UNIT;
    }
}
