...
import com.besson.endfield.compat.category.ElectricMiningRigCategory;
...
public class ElectricMiningRigDisplay implements Display {
    private final EntryIngredient input;
    private final EntryIngredient output;

    public ElectricMiningRigDisplay(OreRigRecipe recipe) {
    ...
    public CategoryIdentifier<?> getCategoryIdentifier() {
        return ElectricMiningRigCategory.ELECTRIC_MINING_RIG;
    }
}
