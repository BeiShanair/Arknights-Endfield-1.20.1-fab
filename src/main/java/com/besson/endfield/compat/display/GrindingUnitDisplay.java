...
import com.besson.endfield.compat.category.GrindingUnitCategory;
...
public class GrindingUnitDisplay implements Display {
    private final List<EntryIngredient> inputs;
    private final List<EntryIngredient> outputs;

    public GrindingUnitDisplay(GrindingUnitRecipe recipe) {
    ...
    public CategoryIdentifier<?> getCategoryIdentifier() {
        return GrindingUnitCategory.GRINDING_UNIT;
    }
}
