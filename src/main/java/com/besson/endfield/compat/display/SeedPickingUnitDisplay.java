...
import com.besson.endfield.compat.category.SeedPickingUnitCategory;
...
public class SeedPickingUnitDisplay implements Display {
    private final List<EntryIngredient> inputs;
    private final List<EntryIngredient> outputs;

    public SeedPickingUnitDisplay(SeedPickingUnitRecipe recipe) {
    ...
    public CategoryIdentifier<?> getCategoryIdentifier() {
        return SeedPickingUnitCategory.SEED_PICKING_UNIT;
    }
}
